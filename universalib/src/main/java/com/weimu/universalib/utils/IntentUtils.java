...
public class IntentUtils {
     ...
     * 进入拨号键面
     */
    public static void gotoDialog(Context context, String phoneNumber) {
        //用intent启动拨打电话
     ...
     * --修改通知开关
     */
    public static void openAppInfo(Context mContext) {
    ...
    public static Intent getAllIntent(Context context, String param) {
        ...
        Uri uri = getUriForFile(context, new File(param));
    ...
    public static void openMark(Context context) {
        ...
        try {
            ...
            e.printStackTrace();
            Toast.makeText(context, "检测不到已安装的应用市场", Toast.LENGTH_SHORT).show();
        }
    }
     ...
     * 构造打开APK的Intent
     */
    public static Intent constructOpenApkIntent(Context context, File file) {
        Intent intent = new Intent();
        intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        intent.setAction(Intent.ACTION_VIEW);
        if (Build.VERSION.SDK_INT >= 24) {
     ...
     * 直接打开打开APK
     */
    public static void openApkByFile(Context context, File file) {
        Intent intent = new Intent();
        intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        if (Build.VERSION.SDK_INT >= 24) {
            intent.addFlags(Intent.FLAG_GRANT_READ_URI_PERMISSION);//7.0有效
