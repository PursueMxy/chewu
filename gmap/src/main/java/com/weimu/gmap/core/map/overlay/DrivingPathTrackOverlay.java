package com.weimu.gmap.core.map.overlay;
...
import com.weimu.gmap.core.utils.AMapUtil;
 ...
 * 驾驶 路径追踪
 */
public class DrivingPathTrackOverlay extends RouteOverlay {
    ...
    private boolean isColorfulline = false;//是否要彩虹色
     ...
     */
    public DrivingPathTrackOverlay(Context context, AMap amap, DrivePath path,
